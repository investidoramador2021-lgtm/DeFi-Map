...
- [Benqi](https://benqi.fi/) Native Avalanche DeFi hub for lending, borrowing, and liquid staking with sAVAX.
...
- [LFJ (Trader Joe)](https://lfj.gg/) Leading multi-chain DEX with Liquidity Book concentrated liquidity AMM.
  - [docs](https://docs.lfj.gg/)
...
- [WOOFi](https://fi.woo.org/) DEX powered by Synthetic Proactive Market Making algorithm.
  - [docs](https://learn.woo.org/)
  - [github](https://github.com/woonetwork)

## Derivatives

- [GMX](https://gmx.io/) Decentralized perpetual exchange with low fees and minimal price impact.
  - [docs](https://docs.gmx.io/)
  - [github](https://github.com/gmx-io)
- [DeltaPrime](https://deltaprime.io/) Leveraged yield farming protocol on Avalanche.
