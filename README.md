...
A curated list of DeFi (Decentralized Finance) protocols across major blockchain networks.
...
- [Sky Lending](https://sky.money/) Decentralized lending protocol, formerly MakerDAO.
...
- [Maple](https://maple.finance/) Institutional capital network for undercollateralized lending.
