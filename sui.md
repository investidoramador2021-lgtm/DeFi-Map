...
- [NAVI Protocol](https://naviprotocol.io/) Leading lending and borrowing protocol on Sui with liquid staking integration.
  - [docs](https://naviprotocol.gitbook.io/navi-protocol-docs)
  - [github](https://github.com/naviprotocol)
- [Suilend](https://suilend.fi/) Largest lending protocol on Sui, built by the Solend team.
  - [docs](https://docs.suilend.fi/)
  - [github](https://github.com/suilend)
- [Scallop](https://scallop.io/) Institutional-grade lending protocol with Programmable Transaction Blocks support.
...
- [Volo](https://www.volosui.com/) Liquid staking protocol offering vSUI token with DeFi integration.
...
- [Wormhole](https://wormhole.com/) Cross-chain messaging protocol connecting Sui to other networks.
